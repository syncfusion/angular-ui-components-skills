...
**Step 1: Install Syncfusion Angular Package and theme package**

```bash
npm install @syncfusion/ej2-angular-buttons@latest @syncfusion/ej2-tailwind3-theme@latest --save
```
