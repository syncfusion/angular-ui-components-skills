...
Generate license key from [Syncfusion Portal](https://www.syncfusion.com/account/downloads), then register in `src/main.ts`:
...
# Expected for Angular: "@syncfusion/ej2-angular-*"
```
...
```bash
npm install @syncfusion/ej2-angular-grids@26.1.35 @syncfusion/ej2-angular-buttons@26.1.35
```
...
```
Error: License key platform (React) does not match detected platform (Angular).
```

**Solution (v30.x.x):**
1. Generate Angular platform key
